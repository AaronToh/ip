# ming.app.Ming project template
...
1. After that, locate the `src/main/java/ming.app.Ming.java` file, right-click it, and choose
   `Run ming.app.Ming.main()` (if the code editor is showing compile errors, try restarting the IDE). If the setup is
